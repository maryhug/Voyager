...
def reporte_diagnosticos_frecuentes(lista_pacientes, top_n=None):
    ...
    for diagnostico, cuenta in mas_comunes:
        print(f"{diagnostico}: {cuenta}")
    return contador
...
def reporte_pacientes_mayores_de_60(lista_pacientes):
    ...
    if not tiene_edad:
        print("\nNo hay campo 'Edad' en los registros. "
              "No es posible generar el reporte de mayores de 60.")
        return []
