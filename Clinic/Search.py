from Clinic.Add import pacientes
...
def buscar_nombre():
    ...
    # Recorrer la lista original para ingresar los nombres repetidos a la lista vacía
    for paciente in pacientes:
        if nombre_buscar in paciente['Nombre_completo']:
...
def buscar_diagnostico():
    ...
    # Recorrer la lista original para ingresar los pacientes con el mismo diagnóstico a la lista vacía
    for paciente in pacientes:
